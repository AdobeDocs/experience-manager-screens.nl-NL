...
<table>
 <tbody>
  <tr>
   ...
   <td><strong> Type van Bezit </strong><br /> </td> 
  ...
  <tr>
   <td><strong><em>Source/product van oorsprong</em></strong></td> 
   <td>Naam</td> 
   <td>source.name</td> 
   <td>vereist</td> 
   <td>string</td> 
