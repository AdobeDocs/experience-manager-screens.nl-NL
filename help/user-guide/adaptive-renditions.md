...
1. Navigeer aan **CRXDE Lite**. Controle, als de **vertoning-afbeelding** configuratie in `/conf/screens/sling:configs/rendition-mapping` bestaat, zoals aangetoond in het hieronder cijfer.
   ...
   >[!IMPORTANT]
   >Als u het recentste Pak 202109 van de Eigenschap installeerde, ziet u de **vertoning-afbeelding** knoopstructuur vooraf bevolkt in `/conf/screens/sling:configs/rendition-mapping` in CRXDE Lite. Zie &lbrace;de Nota&#39;s van de Versie voor het Pak 202109 van de Eigenschap [&#x200B; om details op het recentste Pak van de Eigenschap te krijgen.](/help/user-guide/release-notes-fp-202109.md)
