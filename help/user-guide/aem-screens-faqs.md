...
Als er om het even welk *Traversal WARNs van de Vraag* in `error.log` zijn, creeer een douaneindex voor uw vraag. Zie [ Vormend de Indexen ](https://experienceleague.adobe.com/nl/docs/experience-manager-65/content/implementing/deploying/deploying/queries-and-indexing#configuring-the-indexes) voor meer details.
