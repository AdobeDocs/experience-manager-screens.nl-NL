...
1. Er moet een nieuwe optie worden weergegeven *Gebruikersagenten die van hetzelfde kenmerk moeten worden vrijgesteld*. Vul deze met een regex die overeenkomt met de gebruikersagent die niet compatibel is met de *SameSite=None* kenmerk.
   >[!NOTE]
...
1. Het dialoogvenster Apparaatinformatie wordt weergegeven. Selecteer de **Apparaatinfo** en klik op **Bewerken**.
