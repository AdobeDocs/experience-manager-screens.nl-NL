...
1. Ga naar de [Downloads voor AEM Screens Player](https://download.macromedia.com/screens/) kunt u de Tizen-speler downloaden.

1. De Tizen-speler installeren *(.zip)* van uw lokale computer.
...
1. Omlaag schuiven en op de knop **Afspelen als** en wijzigen in de **URL Launcher** -optie.
...
1. Er moet een nieuwe optie worden weergegeven *`User agents to be exempted from samesite attribute`*. Vul deze optie met een regex die aan de gebruikersagent beantwoordt die (zijn) onverenigbaar met is *SameSite=None* kenmerk.
