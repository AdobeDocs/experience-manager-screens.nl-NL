...
# Gebruikershandleiding voor AEM-schermen {#user-guide}
...
+ Configuratie en beheer {#administering}
   ...
   + Analyseintegratie met AEM-schermen {#analytics-integration}
      + [Integratie van Adobe Analytics](adobe-analytics-integration-aem-screens.md)
