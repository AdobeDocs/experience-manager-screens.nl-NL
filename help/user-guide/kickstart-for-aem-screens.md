...
1. Ga naar uw Adobe Experience Manager-exemplaar (AEM) en selecteer **Schermen**. U kunt ook rechtstreeks navigeren vanuit `https://localhost:4502/screens.html/content/screens](https://localhost:4502/screens.html/content/screens`.

1. Selecteren **Schermproject maken** zodat kunt u een project van Schermen tot stand brengen.
1. Voer de titel in als **DemoScreens** selecteert u vervolgens **Opslaan**.
...
1. Nadat u een project creeert, selecteer **DemoScreens** en selecteert u de **Kanalen** map, zoals weergegeven in de onderstaande afbeelding. Selecteren **+ Maken** in de actiebalk.

   ![afbeelding](assets/kickstart/demo-2.png)

1. Kies de optie **Volgekanaal** van de tovenaar en selecteer **Volgende**.
...
1. Selecteren **Bewerken** op de actiebalk (zie de onderstaande afbeelding). De redacteur voor **TestChannel** wordt geopend.

   ![afbeelding](assets/kickstart/demo-6.png)

1. Selecteer het pictogram dat het zijpaneel aan de linkerkant van de actiebalk in- en uitschakelt om de elementen en componenten te openen.
...
1. Selecteren **Locatie** van de tovenaar en selecteer **Volgende**.
1. Voer de **Naam** voor uw locatie (voer de titel in als **TestLocation**) en selecteert u **Maken**.
...
1. Voer de **Titel** als **LobbyDisplay** en selecteert u **Maken**.
...
>1. Selecteren **AEM Screens** Insteekmodule voor het starten van Chrome Player. Standaard wordt de speler gestart in de modus Volledig scherm. Druk **Esc** om de modus Volledig scherm af te sluiten.
...
1. Selecteer de **Apparaatregistratie** van rechtsboven.

1. Selecteer het vereiste apparaat en selecteer **Apparaat registreren**.
...
1. Als de **Registratiecode** is hetzelfde op beide computers, selecteert u **Valideren** in AEM.

1. Stel de gewenste naam in als **ChromeDeviceforDemo** voor het apparaat en selecteer **Registreren**.

   ![afbeelding](assets/kickstart/demo-register4.png)

1. Selecteren **Weergave toewijzen** van de **Apparaatregistratie voltooid** in.

   ![afbeelding](assets/kickstart/demo-register5.png)

1. Selecteer het pad naar uw weergave als **DemoScreens** > **Locaties** > **TestLocation** > **LobbyDisplay** en selecteert u **Toewijzen**.
